...
export class VehiculoCatalogoComponent implements OnInit {
  ...
  alerta(){
    Swal.fire({
      title:"Cotización",
      html:'<label>Para visualizar la cotizacion. Se debe descargar la aplicacion desde el siguiente enlace. </label> <br><br> <a href="https://drive.google.com/file/d/12HWtK0jDTATd7fHTdRJno_0w1BTxXbNU/view?usp=sharing"> Descargar la aplicacion</a> ',
      icon: "info"
    })
  }
}
